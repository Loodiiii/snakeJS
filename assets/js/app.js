document.addEventListener("DOMContentLoaded", () => {
    ...
    //function that deals with ALL ove outcomes of the Snake
    ...
    //generate new applce once apple is eaten
    ...
    function control(e){
        ...
        if(e.keyCode === 39){
            ...
            direction = +width // if we press down, the snaked head will instantly appear in the div ten divs from where you are now
        }
    }
